...
A ideia principal é poder oferecer um design, promover a portabilidade e reduzir o esforço para criar aplicações em geral e web para gerenciar estatisticas de seus dados, sem fazer com que eles acessem diretamente tua base a todo momento. No meu caso em especifico, o primeiro caso era ter um intermediador entre o banco de dados e a aplicação para que a geração de estatisticas seja mais trivial e gere menos impacto.
...
Veja que no campo "enum", eu posso passar a função para ser executada nas
